 ...
 *
 * This profile matches TelU-Connect: PEAP outer authentication with MSCHAPv2 credentials,
 * optional anonymous outer identity, and no CA certificate. It uses Arduino-ESP32's native enterprise
 * WiFi.begin(..., WPA2_AUTH_PEAP, ...) path, retries bounded connection attempts, logs Wi-Fi disconnect
 * reasons, and returns false instead of rebooting when it cannot connect.
 *
 ...
 * @note   Requires Arduino-ESP32 with WPA2-Enterprise support enabled.
 */
